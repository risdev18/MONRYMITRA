                ...
                <div className="space-y-4">
                    {businesses.length === 0 ? (
                        <div className="text-center py-12 opacity-40">
                            ...
                            <p className="text-xs font-black uppercase tracking-widest text-slate-400">No businesses found</p>
                        </div>
                    ) : (
                        businesses.map((b) => (
                                ...
                                <div className="flex items-center gap-2">
                                    {b.paymentStatus === 'PAID' ? (
                                        <button
                                            ...
                                            className="px-4 py-2 bg-slate-200/50 text-rose-600 rounded-xl text-[10px] font-black uppercase hover:bg-rose-600 hover:text-white transition flex items-center gap-2"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-[10px] font-black uppercase hover:bg-emerald-500 transition shadow-lg shadow-emerald-100 flex items-center gap-2 animate-pulse"
                                        >
